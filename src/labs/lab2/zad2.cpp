...
int main(void)
{
    ...
    GLSLProgram program{"vertex_zad2.glsl", "fragment_zad1.glsl"};
    GLSLProgram program2{"vertex_zad2.glsl", "fragment_zad2.glsl"};
    ...
    while(!window.shouldClose())
    {
        ...
        mesh.drawArrays(0, N/2*3);

        program2.use();
        program.setUniform("N", (float)N);
        mesh.drawArrays(N/2*3, N/2*3);
